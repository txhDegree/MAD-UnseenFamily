...
class CompletedFragment (private val itemsOnClickListener: VPRecycleViewAdapter.DonationOnClickListener) : Fragment() {
    ...
    override fun onResume() {
        ...
        donationViewModel.completeDonationList.observe(viewLifecycleOwner){
            if(it.isEmpty())
