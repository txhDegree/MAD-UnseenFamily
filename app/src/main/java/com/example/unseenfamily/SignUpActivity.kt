...
import com.example.unseenfamily.databinding.ActivitySignUpBinding
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            binding.textViewSignUpErrorMsg.text = ""
                ...
                if (pass == confirmPass) {
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener {
                        if (it.isSuccessful) {
                            ...
                            binding.textViewSignUpErrorMsg.text = it.exception?.message
                        }
                    }
                } else {
